exports.seed = function (knex) {
  ...
  return knex('citySearch')
    .del()
    .then(function () {
      return knex('citySearch').insert([
        {
          id: '1',
          city: 'Hackensack',
          state: 'New Jersey',
